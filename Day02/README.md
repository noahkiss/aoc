...
In game 1, three sets of cubes are revealed from the bag (and then put backagain). The first set is `3 blue` cubes and `4 red` cubes; the second set is `1 red`cube, `2 green` cubes, and `6 blue` cubes; the third set is only `2 green` cubes.
